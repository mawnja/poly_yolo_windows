...
extern void run_poly_detector(int argc, char **argv);
...
int main(int argc, char **argv)
{
	/*
	argc = 8;
	argv[0] = "../../build/darknet/x64/darknet.exe";
	//argv[1] = "classifier";
	argv[1] = "poly_detector";
	argv[2] = "train";
	argv[3] = "../../data/cityscapes_poly.data";
	//argv[3] = "../../data/plr_poly.data";
	//argv[4] = "../../cfg/yolov3-spp_plr_poly4.cfg";
	argv[4] = "../../cfg/yolov3-spp_ariginal_cityscapes_poly24.cfg";
	//argv[5] = "../../backup/car-lite_best.weights";
	//argv[5] = "../../backup/yolov3-spp_cityscapes_p23r059010_936000.weights";
	argv[5] = "-gpus";
	argv[6] = "0";
	argv[7] = "-map";
	//argv[8] = "-dont_show";
    ...
    } else if (0 == strcmp(argv[1], "poly_detector")) {
		run_poly_detector(argc, argv);
